...
This is where you will type in commands to submit jobs, check the status of jobs, and various other things. For now, you can check that your account was registered properly by typing "id", and pressing enter.
