#!/bin/bash
#SBATCH --job-name=separate-unmapped-HAV       # Job name
...
#SBATCH --output=separate-unmapped-HAV_%j.log  # Standard output and error log

pwd; hostname; date

module load samtools/1.10 seqtk/1.3

echo "Separating mapped and unmapped reads for havanesis"
