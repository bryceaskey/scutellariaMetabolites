...
bcftools mpileup -Ov -f ${ref} ${sorted_aln} | bcftools call -c -o ${output_dir}ALT_aln.vcf
bcftools filter -Ov -i '%QUAL>20' ${output_dir}ALT_aln.vcf -o ${output_dir}ALT_aln_filtered.vcf
