#!/bin/bash
#SBATCH --job-name=RNAseq-HISAT2-SRP179837-leaf3       # Job name
...
#SBATCH --output=RNAseq-HISAT2-SRP179837-leaf3_%j.log  # Standard output and error log

pwd; hostname; date

module load trimmomatic/0.39 hisat2/2.2.0

echo "Mapping SRP179837 (baicalensis) leaf3 RNAseq data to baicalensis reference genome"
