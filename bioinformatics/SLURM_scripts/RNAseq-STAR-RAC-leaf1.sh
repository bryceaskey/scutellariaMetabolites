#!/bin/bash
#SBATCH --job-name=RNAseq-STAR-RAC-leaf1       # Job name
...
#SBATCH --output=RNAseq-STAR-RAC-leaf1_%j.log  # Standard output and error log

pwd; hostname; date

module load star/2.7.3a

echo "Mapping racemosa leaf1 RNAseq data to baicalensis reference genome"
...
STAR --runThreadN 1 --outFilterMultimapNmax 2 --genomeDir ${ref} --readFilesIn ${reads}${sp}_${rep}_1.fastq ${reads}${sp}_${rep}_2.fastq > ${aln}${sp}_${rep}.sam