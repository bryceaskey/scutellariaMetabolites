#!/bin/bash
#SBATCH --job-name=wgs-alignment-novo-RAC        # Job name
...
#SBATCH --output=wgs-alignment-novo-RAC_%j.log   # Standard output and error log
...
novoalign -d ${ref}GCA005771605.nix -f  ${wgs}RAC_1.fq ${wgs}RAC_2.fq -o SAM > ${output_dir}RAC_novoaln.sam
