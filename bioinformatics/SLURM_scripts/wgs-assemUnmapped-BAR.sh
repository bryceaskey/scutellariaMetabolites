#!/bin/bash
#SBATCH --job-name=wgs-assemUnmapped-BAR       # Job name
...
#SBATCH --output=wgs-assemUnmapped-BAR_%j.log  # Standard output and error log

pwd; hostname; date

module load  intel/2018.1.163 boost/1.71.0 openmpi/3.1.0 sparsehash/2.0.3 abyss/2.1.0

echo "Assembling unmapped barbata reads into contigs"
