#!/bin/bash
#SBATCH --job-name=wgs-alignment-novo-BAR        # Job name
...
#SBATCH --output=wgs-alignment-novo-BAR_%j.log   # Standard output and error log
...
novoalign -d ${ref}GCA005771605.nix -f  ${wgs}BAR_1.fq ${wgs}BAR_2.fq -o SAM > ${output_dir}BAR_novoaln.sam
