#!/bin/bash
#SBATCH --job-name=wgs-blastUnmapped-ALT       # Job name
...
#SBATCH --output=wgs-blastUnmapped-ALT_%j.log  # Standard output and error log
...
blastn -query ${contigs}ALT/ALT_unmapped-6.fa -db ${db}nt -out ${output}ALT_unmappedBLAST.out -outfmt 6