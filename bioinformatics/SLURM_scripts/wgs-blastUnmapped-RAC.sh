#!/bin/bash
#SBATCH --job-name=wgs-blastUnmapped-RAC       # Job name
...
#SBATCH --output=wgs-blastUnmapped-RAC_%j.log  # Standard output and error log
...
blastn -query ${contigs}RAC/RAC_unmapped-6.fa -db ${db}nt -out ${output}RAC_unmappedBLAST.out -outfmt 6