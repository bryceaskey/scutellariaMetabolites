#!/bin/bash
#SBATCH --job-name=RNAseq-HISAT2-RAC-leaf3       # Job name
...
#SBATCH --output=RNAseq-HISAT2-RAC-leaf3_%j.log  # Standard output and error log

pwd; hostname; date

module load adapterremoval/2.2.2 hisat2/2.2.0

echo "Mapping racemosa leaf3 RNAseq data to baicalensis reference genome"
