#!/bin/bash
#SBATCH --job-name=RNAseq-HISAT2-RAC-root2       # Job name
...
#SBATCH --output=RNAseq-HISAT2-RAC-root2_%j.log  # Standard output and error log

pwd; hostname; date

module load trimmomatic/0.39 hisat2/2.2.0

echo "Mapping racemosa root2 RNAseq data to baicalensis reference genome"
