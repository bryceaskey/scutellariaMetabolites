...
rawData <- read.csv(file="C:/Users/Bryce/Documents/scutellariaMetabolites/data/20200924_wrightii.csv", header=TRUE)
...
wrightiiData <- data.frame(
  ...
  acetoside=sapply(rawData$acetoside[dataRows], ppmConversion, flavonoidName="acetoside", mix1Rows=mix1Rows, mix2Rows=mix2Rows, rawData=rawData)
)
